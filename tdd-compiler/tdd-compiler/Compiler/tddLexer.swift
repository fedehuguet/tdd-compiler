...
open class tddLexer: Lexer {
	...
	static let OPEN_BLOCK=1, CLOSE_BLOCK=2, OPEN_BRACKET=3, CLOSE_BRACKET=4, 
            ...
            CONST=43, DESCRIPTION=44, NUMBER=45, STRING_VAL=46, CHAR_VAL=47, 
            INT_VAL=48, FLOAT_VAL=49, WHITESPACE=50, NEWLINE=51
	...
	static let ruleNames: [String] = [
		...
		"DESC", "STRING_VAL", "CHAR_VAL", "INT_VAL", "FLOAT_VAL", "INT", "FLOAT", 
